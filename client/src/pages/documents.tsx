...
import { Bot, FileText, Search, Trash2, Upload } from "lucide-react";
import { Skeleton } from "@/components/ui/skeleton";
import { useAgentDocuments } from "@/hooks/use-documents";
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="max-h-96 overflow-y-auto space-y-4">
                              <div className="p-4 border border-gray-200 rounded-lg">
                                <h4 className="font-medium text-slate-800 mb-2">customer-manual.pdf</h4>
                                <p className="text-sm text-slate-600">
                                  This section covers the basic installation process for the customer portal...
                                </p>
                                <p className="text-xs text-slate-500 mt-2">Score: 0.85</p>
                              </div>
                            </div>
                          </div>
                        </DialogContent>
